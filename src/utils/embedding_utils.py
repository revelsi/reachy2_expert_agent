...
class HuggingFaceInstructorEmbeddingFunction(EmbeddingFunction):
    ...
    def __init__(
        ...
        self.api_url = (
            api_url
            or os.environ.get("HUGGINGFACE_ENDPOINT_URL")
            or f"https://api-inference.huggingface.co/models/{model_name}"
        )
...
class EmbeddingGeneratorHF(EmbeddingFunction):
    ...
    def __init__(
        ...
        self.embedding_function = HuggingFaceInstructorEmbeddingFunction(
            model_name, api_token, api_url
        )
